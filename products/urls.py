...
from .views import catalog_list_products, admin_list_products, catalog_product_details,admin_product_details, admin_create_product,admin_edit_product,admin_delete_product
urlpatterns = [
